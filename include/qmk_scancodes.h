...
static unsigned int keycode_to_scancode[256] = {
	...
	KEY_X, KEY_Y, KEY_Z, KEY_1, KEY_2,
	KEY_3, //0x20
	KEY_4, KEY_5, KEY_6, KEY_7, KEY_8, KEY_9, KEY_0, KEY_ENTER, KEY_ESC,
	...
	KEY_LEFT, //0x50
	KEY_DOWN, KEY_UP, KEY_NUMLOCK, KEY_KPSLASH, KEY_KPASTERISK, KEY_KPMINUS,
	KEY_KPPLUS, KEY_KPENTER, KEY_KP1, KEY_KP2, KEY_KP3, KEY_KP4, KEY_KP5,
	KEY_KP6, KEY_KP7,
	KEY_KP8, //0x60
	KEY_KP9, KEY_KP0, KEY_KPDOT,
	0, //KC_NONUS_BSLASH
	0, //KC_APPLICATION
	...
	KEY_STOPCD, KEY_PLAYPAUSE, KEY_MEDIA,
	KEY_EJECTCD, // 0xB0
	KEY_EMAIL, KEY_CALENDAR, KEY_COMPUTER, KEY_SEARCH, KEY_HOMEPAGE,
	KEY_BACK, KEY_FORWARD, KEY_EXIT, KEY_REFRESH, KEY_FAVORITES,
	KEY_FASTFORWARD, KEY_REWIND, KEY_BRIGHTNESSUP, KEY_BRIGHTNESSDOWN, 0, 0,
